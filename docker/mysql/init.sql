...
CREATE TABLE `USERS` (
                         ...
                         `is_activate` TINYINT(1) NCREATE TABLE `Refund` (
...
ALTER TABLE `refund_account` ADD CONSTRAINT `FK_USER_DETAIL_TO_refund_account_1` FOREIGN KEY (`user_id`) REFERENCES `USER_DETAIL` (`user_id`);ULL DEFAULT 1,
                         `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
                         `updated_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                         `deleted_at` DATETIME NULL,
                         `role` VARCHAR(20) NULL DEFAULT 'USER' COMMENT 'ADMIN, USER',
