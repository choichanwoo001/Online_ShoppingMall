...
import com.fast_campus_12.not_found.shop.domain.user.dto.UserInfoResponse;
import com.fast_campus_12.not_found.shop.domain.user.dto.UserUpdateRequest;
import com.fast_campus_12.not_found.shop.domain.user.dto.User;
import com.fast_campus_12.not_found.shop.domain.user.dao.UserDAO;
import com.fast_campus_12.not_found.shop.domain.user.dto.UserAddress;
import com.fast_campus_12.not_found.shop.domain.user.dto.UserDetail;
...
public class UserService {
    ...
    public static final Pattern PASSWORD_PATTERN = Pattern.compile("^(?=.*[A-Z])(?=.*[a-z])(?=.*\\d)(?=.*[!@#$%^&*()_\\-+=\\[{\\]};:'\",<.>/?\\\\|`~])[A-Za-z\\d!@#$%^&*()_\\-+=\\[{\\]};:'\",<.>/?\\\\|`~]{8,16}$");
