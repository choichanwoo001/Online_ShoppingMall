...
package com.fast_campus_12.not_found.shop.domain.order.controller;

import com.fast_campus_12.not_found.shop.domain.order.dto.CouponDto;
import com.fast_campus_12.not_found.shop.domain.order.dto.OrderUserDetailServiceDto;
import com.fast_campus_12.not_found.shop.domain.order.dto.ProductOrderInfoDto;
import com.fast_campus_12.not_found.shop.domain.order.dto.UserAddressDto;
import com.fast_campus_12.not_found.shop.domain.order.dto.Order;
import com.fast_campus_12.not_found.shop.domain.order.service.OrderService;
...
//        String sessionId = "Choi3495"; // 테스트용 id
...
//        }
    ...
    @GetMapping("/order/complete/{ordercomplete}")
